<?php
	...
	require_once 'classes/Project_en.php';
	...
	class Proiecte extends PageTemplate
	{
		public function execute()
		{
			...
			{
				$href_next_project = 'en/Project-'.$project->getNextproject();
			}
			else
			{
				$href_next_project = "#";
			...
			{
				$href_prev_project = 'en/Project-'.$project->getPrevProject();
			}
			else
			{
				$href_prev_project = "#";
			...
			$this->templateEngine->load($data, 'proiecte_en.html');
		}
