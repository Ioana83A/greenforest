<?php
	...
	require_once 'classes/ChairsPatraCollectionEn.php';
	//header_remove("X-Powered-By");

	
	class ScauneColectiaPatra extends PageTemplate
	{
		public function execute()
		{
			...
			$collection = new ChairsPatraCollectionEn($this->query);
			...
			$this->templateEngine->load($data, 'scaune_colectia_patra_en.html');
		}
	...
	$colectia_wagner = new ScauneColectiaPatra();
