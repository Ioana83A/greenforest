<?php
	...
	//$produse->URLCheck();
	require_once 'classes/ChairsEn.php';
	...
	class Produse extends PageTemplate
	{
		public function execute()
		{
			...
			$chairs = new ChairsEn($this->query,$category_seo_name,$subcateg_seo_name, $collection_seo_name,$product_seo_name);
			...
			$this->templateEngine->load($data, 'scaune_en.html');
		}
