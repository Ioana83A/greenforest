<?php
	...
	require_once 'classes/ChairsWagnerCollection.php';
	...
	class ScauneColectiaWagner extends PageTemplate
	{
		public function execute()
		{
			...
			$collection = new ChairsWagnerCollection($this->query);
			...
			$this->templateEngine->load($data, 'scaune_colectia_wagner.html');
		}
