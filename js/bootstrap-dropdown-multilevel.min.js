...
if($DoNotCloseThisOne)return}var relatedTarget={relatedTarget:this}
...
return $parent&&$parent.length?$parent:$this.parent()}$.fn.dropdown=function(option){return this.each(function(){var $this=$(this)
