<?php
	...
	require_once 'classes/ChairsTopstarCollectionEn.php';
	...
	class ScauneColectiaTopstar extends PageTemplate
	{
		public function execute()
		{
			...
			$collection = new ChairsTopstarCollectionEn($this->query);
			...
			$this->templateEngine->load($data, 'scaune_colectia_topstar_en.html');
		}
