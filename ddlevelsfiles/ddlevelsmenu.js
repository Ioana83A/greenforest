...
arrowpointers:{
	downarrow: ["images/down_arrow.jpg", 14,7], //[path_to_down_arrow, arrowwidth, arrowheight]
	rightarrow: ["images/arrow_right_white.gif", 7,14], //[path_to_right_arrow, arrowwidth, arrowheight]
...
revealmenu:function(header, submenu, endpoint, dir){
	...
	if (elapsed<this.effects.duration){
		...
		if (this.effects.enablefade){
			this.setopacity(submenu.parentNode, 1.0)
